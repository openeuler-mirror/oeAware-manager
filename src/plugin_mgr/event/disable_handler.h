 ...
 ******************************************************************************/
#ifndef PLUGIN_MGR_EVENT_DISABLE_HANDLER_H
#define PLUGIN_MGR_EVENT_DISABLE_HANDLER_H
#include "event_handler.h"
#include "instance_run_handler.h"

namespace oeaware {
class DisableHandler : public Handler {
public:
    explicit DisableHandler(std::shared_ptr<InstanceRunHandler> instanceRunHandler)
